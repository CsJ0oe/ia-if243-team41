...
class myPlayer(PlayerInterface):
	...
	def evaluate(self,board) :
		...
		# 	else: 
		# 		score_win=-score_win+500
		# 		#return score_win
		# elif self._mycolor==2:
		# 	if (score_black)<score_white :
		# 		score_win+=20000  
		# 		#return score_win
		...
		for i in range(len(groups_oppo)) :
			score_win=score_win-len(groups_oppo[i])*groups_liberties_oppo[i] + groups_liberties_oppo[i]*2
		...
		# 	score_win=score_win *2  # Win in the next move
		# elif num_endangered_self >1 :
		# 	score_win=-score_win / 2  # Lose in the next move

		# print("--------------self-------------------")
		# print(groups_self)
		# print(groups_liberties_self)
		# print("-------------------------------------")
		
		return score_win + score_groups * normal(1, 0.1) + score_liberties * normal(1, 0.1)
	def getPlayerName(self):
		return "feresbigbooss"
	...
	def getPlayerMove(self):
		...
		print(move)
		#move=self._board.move_to_str(move)
		print(move)
